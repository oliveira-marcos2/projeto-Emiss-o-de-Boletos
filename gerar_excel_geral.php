...
$sql_busca = "SELECT * FROM pagamento WHERE status_cobranca = 'Aguardando Pagamento' 
UNION SELECT * FROM pagamento WHERE status_cobranca = 'Pago'";
...
if($query_busca != null){
    ...
    //nome do arquivo
    header('Content-Disposition: attachment; filename=relatorio_geral.csv');
